...
export default function MeetingDetail() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div className="detail-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '28px 32px 80px' }}>
        ...
        {extracted && (
          <>
            ...
            {activeTab === 'actions' && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="responsive-stack">
              ...
              <div className="fade-up">
                ...
                {sentiment && !sentimentLoading && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    {/* Row 1 — Score + Highlights responsive stack */}
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '20px' }} className='responsive-stack'>
